...
<form action="deletespc.jsp" method="post" style="position: relative;left: 35%;width: 40%">
    输入你要删除的设备id：<input type="text" name="pc">
    <input type="submit" value="确认" style="width:50px;">
    <input type="button" value="返回" style="width: 50px" onclick="window.location.href = 'pc.jsp';">
</form>
<div id="footer" >
