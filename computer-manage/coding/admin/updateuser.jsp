...
<div id="center" style="position:relative;left:30% ; width:40%;" >
    <form action="updatesty.jsp" method="post" style="background:#FFE4E1;width:400px;" align="center">
        <br>
        <h4>请输入要修改的用户信息</h4> <br>
        <h3>输入用户名：</h3>
        ...
        <input type="button" onclick="window.location.href = 'user.jsp'" value="返回" style="width: 50px;font-weight: bold;">
        <br><br>
    </form>
</div>
<div id="footer" >
