...
<div class="students">
    <%
        String path = "D"+request.getParameter("student");
        ...
        if(dirfile.exists()){
            ...
            if(files!=null){
                for(File that:files){
                    String need = that.getName()+"&name="+request.getParameter("student");
    %>
    <div>
        <a href="download.jsp?file=<%=need%>" style="margin-top: 20px;text-decoration: none"><img src="../picture/work.png" style="width: 32px;height: 32px;"><br><%=that.getName()%></a>
    </div>
    <%
                }
            }
    ...
    %>
    <a href="showhomeworks.jsp" style="margin-top: 20px;text-decoration: none"><img src="../picture/return.png" style="width: 32px;height: 32px;" title="返回"><br></a>
</div>
